...
export function CallToAction() {
  return (
    <section className="relative overflow-hidden py-32">
      {/* Background - Deep Space / Aurora Effect */}
      ...
      <div className="container relative z-10 mx-auto px-6 text-center">
        ...
        <div className="mt-12 flex flex-col items-center justify-center gap-6 sm:flex-row">
          <Link href="/create">
            <Button
              size="lg"
              className="group relative h-14 overflow-hidden rounded-full border-0 bg-primary px-8 text-lg text-primary-foreground shadow-[0_0_40px_-10px_rgba(var(--primary),0.5)] transition-all hover:scale-105 hover:shadow-[0_0_60px_-15px_rgba(var(--primary),0.6)]"
            >
          ...
          <Link href="/join">
            <Button
              variant="outline"
              size="lg"
              className="group h-14 rounded-full border-white/10 bg-white/5 px-8 text-lg text-white backdrop-blur-sm transition-all hover:border-white/20 hover:bg-white/10"
            >
              Have a code?
